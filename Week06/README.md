...
13. 다음 밑줄에 들어갈 말은?
	...
	```
	document.body._____(_____);
	```

	정답: removeChild(\'#third\')

14. 다음 중 false를 반환하는것을 모두 고르시오. false라면 true값이 나오도록 고치시오
...
15. 같은 엘리먼트에 2개이상의 css규칙이 적용된 경우: 우선순위가 높은 것부터 나열하시오
...
16. 다음 중 기능이 없어 자바스크립트로 동작을 구현해야 하는 것은?
